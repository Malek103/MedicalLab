            ...
            <tbody>
              @foreach ($examination as $key => $examinations)
                <tr>
                  ...
                  <td><a href="{{ '/show-examination/' . $examinations->MEID }}" class="btn btn-warning" tabindex="{{ $key + 1 }}">عرض</a></td>
              @endforeach

            </tbody>
          </table>
          <div class="mt-5 mr-5 py-3">
            <a href="{{ url()->previous() }}" class="btn btn-outline-dark w-25 mx-2" tabindex="100">الرجوع</a>
          </div>
        </div>
