    ...
    <div id="main" class="col-md-9">
      ...
      <div class="justify-content-md-center">
        ...
        <div class="container text-center">
          ...
          @endif
          <div id="left" class="text-right">
            {{-- Content --}}
            <form class="d-flex w-25" action="{{ '/search-patient/' . $lid }}" method="get">
              @csrf
              {{ method_field('PUT') }}
          ...
          <table class="table">
            <thead class="table-dark">
              <tr>
                <th scope="col">#</th>
                <th scope="col">اسم الذمة</th>
                <th scope="col">عنوان الذمة</th>
                <th scope="col">رقم الهاتف</th>
                <th scope="col"> دفع عن حساب </th>
                <th scope="col"> عرض الكشف</th>
              </tr>
            </thead>
            <tbody>
              @foreach ($patient as $key => $patients)
                <tr>
                  ...
                  <td>{{ $patients->PAddress }}</td>
                  <td>{{ $patients->PPhone }}</td>
                  <td><a href="{{ '/pay-receivable/' . $patients->id . '/' . $lid }}" class="btn btn-primary" tabindex="{{ $key + 3 }}">دفع عن الذمة </a></td>
                  <td><a href="{{ '/receivable-show/' . $patients->id . '/' . $lid }}" class="btn btn-warning" tabindex="{{ $key + 4 }}">عرض</a></td>
