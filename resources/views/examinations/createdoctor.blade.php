...
<div class="container-fluid">
    <div class="row">
                        ...
                        <div class="collapse show" id="home-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                ...
                                <li><a class="link-dark rounded" href="{{ '/ShowAll-Examination/' . $lid }}">بحث عن
                                        فحص</a></li>
                                <li><a class="link-dark rounded" href="{{ '/doctor-Examination/' . $lid }}"> اضافة
                                        طبيب
                                    </a></li>
                            </ul>
                        </div>
        ...
        <div id="main" class="col-md-9">
            ...
            @endif
            <form method="POST" action="/storeDoctor/{{ $lid }}">
                @method('POST')
                @csrf
                @if ($errors->any())
                ...
                <table class="table table-bordered" id="dynamicAddRemove">
                    <tr>
                        <td collapse="2">
                            <input type="text" name="doctorname" id="doctorname" placeholder="أسم  الطبيب"
                                class="form-control text-right" required />
                            <input type="hidden" value="{{ $lid }}" name="id" required>
                        </td>
                        <td class="text-right">
                            <h4>اسم الطبيب</h4>
                        </td>
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-success form-control">انشأ</button>
                </div>
            </form>
        </div>
