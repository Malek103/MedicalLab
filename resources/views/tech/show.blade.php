  ...
  <div class="row">
    ...
    <div id="main" class="col-md-9">
      <div class="justify-content-md-center">
        <h3 class="text-center">فنيين المختبر</h3>
        <table class="table">
          ...
          <tbody>
            @foreach ($techs as $key => $tech)
              <tr>
                ...
                {{-- <td><a href="{{ '/AddTechLab/'.$tech->id.'/'.$lid }}"  class="btn btn-success">اضافة فني</a></td> --}}
      ...
      <hr>
      <div class="justify-content-md-center">
        <h3 class="text-center">فنيين باقي المختبرات</h3>
        <table class="table">
          <thead class="table-dark">
            <tr>
              <th scope="col">#</th>
